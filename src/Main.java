...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        //Create the jsonReader object with the file location
        JsonReader reader = Json.createReader(new FileReader("src/Student.json"));

        // Creates the json tree structure
        JsonStructure jsonst = reader.read();
        JsonObject object = (JsonObject) jsonst;
        // to navigate the tree we will use a
